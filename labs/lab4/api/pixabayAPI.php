...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      //don't delete ampersand when replacing api key
      CURLOPT_URL => "https://pixabay.com/api/?key=6509313-f5a99eb5acf8140d6e87366d1&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
